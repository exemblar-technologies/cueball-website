...
<img alt="" src={esrb} className="img-fluid esrb  img-2 padd-bottom float-right"/>
<img alt="" src={unity} className="img-fluid unity  img-2-3  padd-bottom float-right"/>
...
<li className="ff"><img alt="" src={lang} className="img-fluid lang zoom"/>BROWSE LOCATIONS</li>

<Link to="/help">
<li className="ff"><img alt="" src={help2} className="img-fluid lang zoom"/> HELP CENTER</li>
</Link>

<Link to="/leaderboards">
<li className="ff"><img alt="" src={leader2} className="img-fluid lang zoom"/>LEADER BOARDS</li>
</Link>
...
<a rel="noreferrer" href="https://optimalsplus.com/careers" target="_blank">
<li className="ff"><img alt="" src={careers} className="img-fluid lang zoom"/>CAREERS</li>
</a>

<li className="ff"><img alt="" src={community} className="img-fluid lang zoom"/>COMMUNITY</li>
<Link to="/news">
<li className="ff"><img alt="" src={news} className="img-fluid lang zoom"/>NEWS & UPDATE</li>
</Link>
...
<a rel="noreferrer" href="https://optimalsplus.com/privacy" target="_blank">
